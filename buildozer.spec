...
requirements = python3,kivy==2.1.0,opencv-python-headless==4.6.0.66,numpy,plyer
...
# (list) Permissions
android.permissions = INTERNET,ACCESS_FINE_LOCATION,ACCESS_COARSE_LOCATION,CAMERA,WRITE_EXTERNAL_STORAGE
